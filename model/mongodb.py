...
def constructor_stock():
    client = Mongoclient('mongodb://jay900411:r224697146@ac-jcnyyjh-shard-00-00.zwmifuf.mongodb.net:27017,ac-jcnyyjh-shard-00-01.zwmifuf.mongodb.net:27017,ac-jcnyyjh-shard-00-02.zwmifuf.mongodb.net:27017/?ssl=true&replicaSet=atlas-6vruxq-shard-0&authSource=admin&retryWrites=true&w=majority')
    db = client[stockDB]
    return db
